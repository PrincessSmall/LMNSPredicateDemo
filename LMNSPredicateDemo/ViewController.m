...
- (void)viewDidLoad {
    ...
    NSLog(@"%@",tepAr);
    //4. 综合例子
    NSArray * textArr = @[[LMPerson personWithName:@"lily" age:12 sex:@"female"],
                          [LMPerson personWithName:@"jack" age:16 sex:@"male"],
                          [LMPerson personWithName:@"tom" age:18 sex:@"male"],
                          [LMPerson personWithName:@"mary" age:23 sex:@"female"],
                          [LMPerson personWithName:@"hurry" age:30 sex:@"female"]
                          ];
    NSPredicate * pred1 = [NSPredicate predicateWithFormat:@"sex BEGINSWITH 'female'"];
    NSPredicate * pred2= [NSPredicate predicateWithFormat:@"name CONTAINS 'm'"];
    NSArray * newarr = [textArr filteredArrayUsingPredicate:pred1];
    NSLog(@"newArr %@",newarr);
    NSLog(@"%@",[textArr filteredArrayUsingPredicate:pred2]);
